...
class Vits(BaseTTS):
    ...
    def get_aux_input_from_test_sentences(self, sentence_info):
        ...
        # get language id
        print("************** language_name ****************** : " + str(language_name))
        ...
        if language_name == "en_US":
            ...
            print("************ wrong language_name : ************************" + str(language_name))
            print("************* language_id : *************************" + str(language_id))
        return {
            "text": text,
    ...
    def test_run(self, assets) -> Tuple[Dict, Dict]:
        ...
        print("************ test sentences : ****************" + str(test_sentences))
        for idx, s_info in enumerate(test_sentences):
            print("************** idx : ********************" + str(idx))
            print("************* s_info : ******************" + str(s_info))
            aux_inputs = self.get_aux_input_from_test_sentences(s_info)
            print("***************** aux_inputs : *************************" + str(aux_inputs))
